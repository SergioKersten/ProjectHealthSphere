...
public class Main {
    public static void main(String[] args) {
        ...
        Employee e2 = new Employee(2, "Schulze", "Benjamin", "0454534536", "be@web.de", 
        ...
        patientenManager.getAll().forEach(p -> 
            System.out.println("- " + p.getFirstname() + " " + p.getName() + " (Tel: " + p.getPhonenumber() + ")"));
        
        System.out.println("\nMitarbeiter:");
        employeeManager.getAll().forEach(e -> 
            System.out.println("- " + e.getFirstname() + " " + e.getName() + " (" + e.getDepartment() + ")"));
        ...
        if (gefunden != null) {
            System.out.println("Patient gefunden: " + gefunden.getFirstname() + " " + gefunden.getName());
        }
